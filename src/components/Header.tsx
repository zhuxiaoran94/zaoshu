import { Download, FlaskConical, FolderCog, Play, ShieldCheck, Upload, X } from './Icons'
...
export default function Header({onExport,onProject,onSchemaImport}:{onExport:()=>void;onProject:()=>void;onSchemaImport:()=>void}) {
