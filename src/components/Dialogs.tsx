...
export function ExportDialog({open,onClose}:{open:boolean;onClose:()=>void}) {
  ...
  const formats=[['schema','Schema 契约包','无需生成 · JSON Schema / OpenAPI / TS / DDL'],['mock-api','Mock API 项目','MSW v2 · CRUD / 分页 / 搜索 / OpenAPI'],['bundle','完整交付包','JSON / CSV / SQL / 报告'],['json','JSON','完整多表结构'],['jsonl','JSON Lines','当前表逐行 JSON'],['csv','CSV','当前表，通用表格'],['tsv','TSV','当前表，制表符分隔'],['yaml','YAML','完整多表结构'],['xml','XML','完整多表结构'],['xlsx','Excel XLSX','多表工作簿'],['mysql','MySQL SQL','批量 INSERT 脚本'],['postgres','PostgreSQL SQL','批量 INSERT 脚本'],['sqlite','SQLite SQL','批量 INSERT 脚本'],['postman','Postman 数据','Collection Runner'],['playwright','Playwright','TypeScript Fixture'],['cypress','Cypress','TypeScript Fixture'],['jest','Jest','TypeScript Fixture'],['pytest','pytest','参数化测试文件'],['junit','JUnit','参数化 CSV'],['markdown','覆盖报告','Markdown 文档']]
