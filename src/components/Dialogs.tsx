...
export function ExportDialog({open,onClose}:{open:boolean;onClose:()=>void}) {
  const s=useAppStore();const [format,setFormat]=useState('json');useEffect(()=>{if(open&&!s.result)setFormat('schema')},[open,s.result]);if(!open)return null
